...
tabConfig=[0; pi/4; -pi/4; 0];%konfiguracja w formie wektora, pozwala to uzywac pewnych funkcji
%ConfTmp=ConfigManip(randomConfiguration(robot), tabConfig);%ta funkjca
%dziala la domyslnego typu koniguracji
showdetails(robot)
